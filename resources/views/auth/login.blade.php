        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <a href="/"> <img class="mb-2" src="assets/images/logo/undraw_order_ride_re_372k.svg"
                            height="300" alt="Logo"></a>

                    <h6 class="auth-title mb-2">ระบบการตรวจเช็คสถาพรถ</h6>
                    <hr>
                    <p class="auth-subtitle mb-5">ยินดีต้อนรับ </p>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <button class="btn btn-dark btn-block btn-lg shadow-lg mt-5">{{ __('เข้าสู่ระบบ') }}</button>
